...
namespace ClientePBL03
{
     ...
     */
        ...
        */
        ...
        public bool AddEdge(Aeroporto start, Aeroporto end, int cost)
        {
            if (end == null)
            {
                return false;
            ...
            Rota e = new Rota(start, end, cost);
        ...
        public bool RemoveEdge(Aeroporto end)
        {
            foreach (Rota e in edges)
            {
                if (e.end.name == end.name)
                {
        ...
        public string info()
        {
            ...
            nodeString.Append($"Nó: {name} " + " | Arestas: ");
            foreach (var rota in edges)
            {
                nodeString.Append($"{rota.end.name}");//" + $" (custo:{rota.cost})" + " - ");
            }
