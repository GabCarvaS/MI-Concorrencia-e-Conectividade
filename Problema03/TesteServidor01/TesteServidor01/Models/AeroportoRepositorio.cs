...
using System.Text;
using TesteServidor01.Controllers;
...
namespace TesteServidor01.Models
{
    public class AeroportoRepositorio : IAeroportoRepositorio
    {
        ...
        public AeroportoRepositorio()
        {
            ...
            Aeroporto BSB = new Aeroporto("BSB");
            ...
            SSA.insertEdge(new Rota(SSA,BH,215, "Companhia 01"));           
            
            BSB.insertNeighbors(SSA);
            BSB.insertEdge(new Rota(BSB,SSA,107, "Companhia 01"));

            SP.insertNeighbors(BSB);          
            SP.insertEdge(new Rota(SP, BSB, 50, "Companhia 01"));
            
            RJ.insertNeighbors(BH);
            RJ.insertNeighbors(SP);
            RJ.insertEdge(new Rota(RJ, BH, 554, "Companhia 01"));
            RJ.insertEdge(new Rota(RJ, SP, 90, "Companhia 01"));
           
            BH.insertNeighbors(RJ);
            BH.insertNeighbors(SP);           
            BH.insertEdge(new Rota(BH, RJ, 555, "Companhia 01"));
            BH.insertEdge(new Rota(BH, SP, 101, "Companhia 01"));

            aeroportos.addVertex(BSB);
        ...
        public bool atualizarVaga(string aeroStart, string aeroEnd)//Aeroporto start, Aeroporto end, int poltrona)
        {
